...
public class BoardDao {
	...
	// 게시글 목록 조회 - 페이징 처리 (o)
	public List<BoardDto> getBoardList(Criteria cr){
	...
	// 게시글 상세 조회
	public BoardDto getBoardView(String idx){
		BoardDto mDto = null;
	...
	// 게시글 추가 기능
	public int insertPost(BoardDto mDto) {
		int res = 0;
	...
	// 게시글 수정
	public int updatePost(BoardDto mDto) {
		int res = 0;
